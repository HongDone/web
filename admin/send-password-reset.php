...
if ($con->affected_rows) {
    ...
    Click <a href="$domain_name/admin/resetpassword.php?token=$token">here</a> 
    ...
    try {
        ...
        echo "A messege has been sent, please check!";

    } catch (Exception $e) {

        echo "An error oucurred, check your email again please!";
